...
ax_int.plot(time, vfit_results['m0_amplitude']/signals.max(), 'o-', label='total signal (1 peak fit)')
ax_int.plot(time, m1_amplitude/signals.max(), 'o', label='peak 1')
ax_int.plot(time, m2_amplitude/signals.max(), 'o', label='peak 2')
...
ax.plot(time, vfit_results['m0_center'], 'o', label='peak 0 (1 peak fit)')
ax.plot(time, m1_center, 'o', label='peak 1')
ax.plot(time, m2_center, 'o', label='peak 2')
...
# ax_par.plot(time, vfit_results['m0_fraction'], 'o-', label='fraction peak 0 (1 peak fit)')
...
ax_par.plot(time, vfit_results['r-suqared_1peak'], 'o-', label='r-squared (1 peak fit)')
ax_par.plot(time, vfit_results['r-squared_2peaks'], 'o-', label='r-squared (2 peaks fit)')
