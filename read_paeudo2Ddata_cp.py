...
expn = 75
path = r"C:\Users\Santi\OneDrive - University of Cambridge\NMRdata\400dnp\2025-11-13_3.2mm_Rui-dendrites/"
muestra = "19F_CP_7Li-to-19F_RUI_CC-protocol"
...
for popt_subfile in popt_subfiles:
    ...
    for kk in range(spec.shape[0]):
        ...
        if save:    
            data_to_save = np.array([ppmAxis, spec[kk,:]]).T  # columnas: ppm y señal
            filename = f"{savepath}/contactTime_{popt_par[kk]}us.dat"
...
if save:
    ...
    np.savetxt(tau_file, popt_parlist, header="P15 [us]")
