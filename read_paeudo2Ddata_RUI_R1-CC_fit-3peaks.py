...
NOTA: 17/09
PROBE QUE EL SIGMA SEA EL MISMO PARA TODOS LOS PICOS, Y PARECE QUE FUNCIONA BIEN
NO FUNCIONO
"""
...
m1_center, m2_center, m3_center = [237, 245, 255]
sigma = 6.5
...
ax_int.plot(time, m1_amplitude/signals.max(), 'ro', label='peak 1: 237 ppm')
ax_int.plot(time, m2_amplitude/signals.max(), 'bo', label='peak 2: 245 ppm')
ax_int.plot(time, m3_amplitude/signals.max(), 'go', label='peak 3: 254 ppm')
